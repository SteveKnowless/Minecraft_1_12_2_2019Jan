...
#Name: TreasureSlime.zs

print("Initializing 'TreasureSlime.zs'...");
...
val treasure_slimePool = treasure_slimeTable.getPool("treasureslime_spawnitem");
	...
	treasure_slimePool.addItemEntry(<everlastingabilities:ability_totem>, 1);
	
print("Initialized 'TreasureSlime.zs'");
